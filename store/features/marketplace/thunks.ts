...
export const fetchMoreListings = createAsyncThunk(
  ...
  async (filters: ListingFilters, { rejectWithValue }) => {
    try {
      ...
      return rejectWithValue(
        error instanceof Error ? error.message : 'Failed to fetch more listings',
      )
    }
  },
)
...
export const fetchMyListings = createAsyncThunk(
  ...
  async (_, { rejectWithValue }) => {
    try {
      ...
      return rejectWithValue(
        error instanceof Error ? error.message : 'Failed to fetch your listings',
      )
    }
  },
)
...
export const updateListingThunk = createAsyncThunk(
  'marketplace/update',
  async (
    { listingId, data }: { listingId: string; data: Partial<CreateListingData> },
    { rejectWithValue },
  ) => {
    try {
