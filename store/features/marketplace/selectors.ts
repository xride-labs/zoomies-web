...
export const selectMyListings = (state: RootState) => state.marketplace.myListings
export const selectSavedListings = (state: RootState) => state.marketplace.savedListings
export const selectCurrentListing = (state: RootState) => state.marketplace.currentListing
export const selectMarketplaceFilters = (state: RootState) => state.marketplace.filters
...
export const selectMarketplaceHasMore = (state: RootState) => state.marketplace.hasMore
