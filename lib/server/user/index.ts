...
export async function getMe(): Promise<{
  ...
  return apiAuthenticated.get<{ user: UserProfile & { roles: string[] } }>('/account/me')
}
 ...
 */
export async function getPublicProfile(username: string): Promise<{ user: UserProfile }> {
...
export async function updateBike(
  ...
  return apiAuthenticated.patch<{ bike: Bike }>(`/users/me/bikes/${bikeId}`, data)
}
